...
export default function LandingPage() {
  ...
  return (
    ...
    >
      ...
      >
        <Box display="flex" flexDirection="column" alignItems="center" mb={4} p={4}  spacing={2} bgcolor=" #90ee90" borderRadius={10} boxShadow={2}>
          <Typography variant="h2"  mb={2} sx={{ fontWeight: 'bold', textAlign: 'center',fontFamily:'monospace' }}>
          Welcome to Food Pantry
          </Typography>
          <Typography variant="h6" mb={4} sx={{ textAlign: 'center' ,fontFamily:'monospace' }}>
           Effortless Pantry Management at Your Fingertips.
          </Typography>
          <Button
            variant="contained"
            color="success"
